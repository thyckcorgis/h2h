  ...
  return (
    <View>
      ...
      <Text style={styles.smallText}>
        ...
        questions to encourage diverse conversation for any mood.
      </Text>
      <Text style={styles.smallText}>
      ...
      <Text style={styles.smallText}>
        3. Self-reflection: Talking to other people can teach you about
        yourself.
      </Text>
      <Text style={styles.smallText}>
      ...
      <Text style={styles.smallText}>
        ...
        anonymously. This can offer a way for you to ask questions you would be
        too scared to say outloud.
      </Text>
    </View>
  );
}
